...
export default function NoticeBoard() {
  const Notice = [
    {
      ...
      path :
          "http://www.ignou.ac.in/ignou/bulletinboard/news/latest/detail/Hall_Ticket_for_June_2022_Term_End_Examination-854",
      className : "nav-text",
    },
    {
  ...
  return (<><div className = "notice-board"><h2>Notice Board<
          /h2>
        <ul>
